...
export default class EXRenderProductList extends Component {
  render() {
    /*
        Props là gì?
        - Props là thuộc tính có sẵn của React class component dùng để nhận gía trị từ nơi sử dụng thẻ  component này truyền vào (Component cha truyền vào)
        Props khác state?
        - Props và State đều là thuộc tính có sãn của component để chứa dữ liệu và binding lên giao diện
        + State có thể setState (Gán lại giá trị mới)
        + Props thì readonly giá trị không thể thay đổi
    */

    return (
      <div className='container'>
        <h2>EXRenderProductList</h2>
        <h3>Shoes Shop</h3>
        <ProductListItem arrProduct={data}/>
      </div>
    )
  }
}
