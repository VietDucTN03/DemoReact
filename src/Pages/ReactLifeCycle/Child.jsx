...
/*
    ...
    Lưu ý: Nhận biết sự thay đổi props trên primitive value(boolean, string, number, undefined, null)
...
//     // Can thiệp vào should update để biết là bấm nút number thì không render lại, còn bấm nút like phải render lại.
